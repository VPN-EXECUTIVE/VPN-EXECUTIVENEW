...
if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
    ...
    echo -e "\e[41m          Delete Shadowsocks Account     \E[0m"
    echo -e "\033[1;96m─────────────────────────────────────────\033[0m"
    echo ""
...
rm -f /etc/shadowsocks/ss-$user-config.txt
systemctl restart xray@ss-ws.service
systemctl restart xray@ss-grpc.service
clear
echo -e "\033[1;96m─────────────────────────────────────────\033[0m"
